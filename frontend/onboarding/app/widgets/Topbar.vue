<template>
    <div class="topbar">
        <div class="logo">
            ...
            <span>
                C<span class="hide-on-mobile">ode</span>H<span class="hide-on-mobile">ub</span>
            </span>
            <span class="logo__bracket">/&gt;</span>
            <div class="logo__dot" />
        </div>
                ...
                <div class="step-track__step">
                    <div
                        :class="[
                            'step-track__num',
                            {
                                'step-track__num--done':
                                    getStepStatus(stepsOrder[index]!) === 'completed',
                            },
                            {
                                'step-track__num--active':
                                    getStepStatus(stepsOrder[index]!) === 'active',
                            },
                        ]"
                    >
                        <template v-if="getStepStatus(stepsOrder[index]!) === 'completed'"
                            >✓</template
                        >
