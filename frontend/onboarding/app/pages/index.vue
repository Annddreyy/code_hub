            ...
            >
              <div class="languages">
                <LanguageCard
                  ...
                  :key="language.id"
                  v-bind="language"
                  @select="(language: Language) => userChoices.languages.push(language)"
                  @deselect="
                    (language: Language) =>
            ...
            >
              <div class="experiences">
                <ExperienceLevelCard
                  ...
                  @deselect="
                    (experienceLevel: ExperienceLevel) =>
                      (userChoices.experienceLevels = userChoices.experienceLevels.filter(
                        (experience) => experience.id !== experienceLevel.id,
                      ))
                  "
                />
              </div>
            ...
            >
              <div class="goals">
                <GoalCard
                  ...
                  @deselect="
                    (goal: Goal) =>
                      (userChoices.goals = userChoices.goals.filter((elem) => elem.id !== goal.id))
                  "
                />
              </div>
            </StepWrapper>
