...
export const userApi = {
    ...
    getLeaderboardStatistics: async (page: number, period: string) => {
        return (await instance.post('leaderboardusers', { page, period })).data;
    },

    getPodiumUsers: async (period: string) => {
        return (await instance.post('leaderboardusers/podium', { period })).data;
    },
};
